...
class CascadePlot(CascadePlot):
    ...
    def __init__(self, df, eff=None, stream=None, **kwargs):
        ...
        eff: string, optional
            ...
            either "app" or "arch". If no value is provided, the efficiency
            is selected automatically based on the data available in `df`.
        ...
        **kwargs: properties, optional
        ...
        if len(efficiency_columns) == 0:
            msg = (
                "DataFrame does not contain an 'app eff' or 'arch eff' column."
            )
