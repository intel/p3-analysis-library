...
\begin{tikzpicture}
    ...
    \nextgroupplot[
        ...
        xtick=data,
        symbolic x coords={\VAR{applications}},
        ymin=0,
        ymax=\ymax,
        enlarge x limits={abs=10pt}
    ]

    \BLOCK{for key, value in pp_bars.items()}\addplot+[ybar, \VAR{app_line_specs[key]}] coordinates { \VAR{value} };
    \BLOCK{endfor} 
    ...
    \BLOCK{for key, value in plat_labels.items()}\addlegendimage{platform legend={ \VAR{value} }} \addlegendentry{\VAR{key}}
    \BLOCK{endfor}
